...
public class DstCostsKey
 implements Identifier<DstCosts> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.alto.service.did.rev141101.cost.map.data.map.DstCostsKey.class.getSimpleName()).append(" [");
        boolean first = true;
