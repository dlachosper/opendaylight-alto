...
public class DstCostsKey
 implements Identifier<DstCosts> {
    ...
    final private PidName _dst;
    
    public DstCostsKey(PidName _dst) {
        this._dst = _dst;
    }
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.alto.service.types.rev141101.cost.map.data.cost.map.DstCostsKey.class.getSimpleName()).append(" [");
        boolean first = true;
