...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "alto-service-types";
    private final String namespace = "urn:opendaylight:alto-service-types";
    private final String revision = "2014-11-01";
    private final String resourcePath = "/META-INF/yang/alto-service-types.yang";
