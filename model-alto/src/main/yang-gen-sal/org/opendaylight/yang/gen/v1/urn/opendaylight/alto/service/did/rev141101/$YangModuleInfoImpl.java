...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "alto-service-did";
    private final String namespace = "urn:opendaylight:alto-service-did";
    private final String revision = "2014-11-01";
    private final String resourcePath = "/META-INF/yang/alto-service-did.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.alto.service.types.rev141101.$YangModuleInfoImpl.getInstance());
