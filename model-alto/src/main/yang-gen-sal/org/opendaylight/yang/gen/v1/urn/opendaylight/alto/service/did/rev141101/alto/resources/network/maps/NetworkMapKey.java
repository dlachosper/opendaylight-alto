...
public class NetworkMapKey
 implements Identifier<NetworkMap> {
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.alto.service.did.rev141101.alto.resources.network.maps.NetworkMapKey.class.getSimpleName()).append(" [");
        boolean first = true;
