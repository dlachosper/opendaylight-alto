...
public class CostMetric
 implements Serializable {
    private static final long serialVersionUID = 2356914039067055375L; 
    /**
    ...
    public static final List<String> PATTERN_CONSTANTS = Arrays.asList("^priv:[0-9a-zA-Z_\\-:\\.]+$");
    ...
    public CostMetric(Enumeration _enumeration) {
        super();
    ...
    public CostMetric(java.lang.String _string) {
        super();
    ...
    public CostMetric(char[] _value) {
        java.lang.String defVal = new java.lang.String(_value);
        CostMetric defInst = CostMetricBuilder.getDefaultInstance(defVal);
     ...
     */
    public CostMetric(CostMetric source) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CostMetric other = (CostMetric) obj;
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(org.opendaylight.yang.gen.v1.urn.opendaylight.alto.service.types.rev141101.CostMetric.class.getSimpleName()).append(" [");
        boolean first = true;
