...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "alto-service";
    private final String namespace = "urn:opendaylight:alto";
    private final String revision = "2014-11-19";
    private final String resourcePath = "/META-INF/yang/alto-service.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.alto.service.did.rev141101.$YangModuleInfoImpl.getInstance());
